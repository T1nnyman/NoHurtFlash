...
public class Config {
    ...
    public static final ModConfigSpec.BooleanValue OLD_HURT_EFFECT_ENABLED;
    public static final ModConfigSpec.ConfigValue<String> GLOW_COLOR_HEX_STRING;
    public static final ModConfigSpec.BooleanValue RAINBOW_MODE_ENABLED;
    public static final ModConfigSpec.DoubleValue RAINBOW_CYCLES_PER_SECOND;
