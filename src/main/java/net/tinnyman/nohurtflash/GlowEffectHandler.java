 ...
 *  - Vanilla stores the glowing state in the entity "shared flags" byte (bit 6).
...
public class GlowEffectHandler {
     ...
     *
     * Key: entity ID
     * Value: always true (map used as an efficient int set)
     */
    ...
    public static void onClientTick(TickEvent.ClientTickEvent event) {
        ...
        for (Entity e : level.entitiesForRendering()) {
            ...
            if (living instanceof Player) continue; // Dont apply to players (PVP advantages)
